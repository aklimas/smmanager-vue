<template>
  ...
  export default {
    ...
    async mounted() {
      ...
      // Load CSS files
      await this.loadStyle('assets/vendor/bootstrap/css/bootstrap.min.css');
      await this.loadStyle('assets/vendor/bootstrap-icons/bootstrap-icons.css');
      await this.loadStyle('assets/vendor/aos/aos.css');
      await this.loadStyle('assets/vendor/glightbox/css/glightbox.min.css');
      await this.loadStyle('assets/vendor/swiper/swiper-bundle.min.css');
      await this.loadStyle('assets/css/main.css');
      ...
      await this.loadScript('assets/vendor/purecounter/purecounter_vanilla.js');
