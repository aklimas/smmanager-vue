        ...
        <v-row class="h-100vh mh-100 auth">
            ...
            <v-col cols="12" lg="4" xl="4" xxl="3" class="d-flex align-center justify-center bg-surface">
                <div class="pa-sm-7 pa-4">
                    <h2 class="text--darken-2 text-h4 font-weight-semibold">Zapomniałeś hasła?</h2>
                    <p class="text-subtitle-1 py-4 text-10">
                        Podaj adres e-mail powiązany z Twoim kontem, a my wyślemy Ci e-mailem link umożliwiający zresetowanie hasła.
                    </p>
                    <ResetPassword />
                    <v-btn size="large" color="lightprimary" to="/auth/login" block class="mt-5 text-primary" flat>Powrót do logowania</v-btn>
                </div>
            </v-col>
        </v-row>
    </div>
